...
;; Face manipulators
;; ----------------------------------------------------------------------------
(defun tla--face-add (str face &optional keymap menu help)
...
(defun tla-reload (directory)
  "Reloads xtla (usually for debugging purpose).
...
If `tla--supports-spaces' is non-nil, use its value.  Otherwise, test
if \"escape\" is listed by \"tla help\", and memorize the result in
