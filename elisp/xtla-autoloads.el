...
;;;;;;  tla-log-edit-mode tla-start-project tla-missing tla-revisions
;;;;;;  tla-make-archive tla-archives tla-bookmarks tla-id-tagging-method
;;;;;;  tla-my-revision-library tla-my-id tla-tree-version tla-help
;;;;;;  tla-logs tla-changelog tla-rm tla-commit tla-file-view-original
;;;;;;  tla-file-ediff tla-view-conflicts tla-conflicts-finish tla-file-diff
;;;;;;  tla-file-ediff-revisions tla-apply-changeset tla-get-changeset
;;;;;;  tla-delta tla-changes-last-revision tla-changes-against tla-changes
;;;;;;  tla-add-log-entry tla-edit-log tla-inventory xtla) "xtla"
;;;;;;  "xtla.el" (16906 35776))
...
;;;;;;  tla-archive-list-mode-hook tla-log-insert-last tla-buffer-quit-mode
;;;;;;  tla-switch-to-buffer-first tla-read-directory-mode tla-read-project-tree-mode
;;;;;;  tla-switch-to-buffer-mode tla-log-buffer tla-log-commands
;;;;;;  tla-bookmarks-cleanup-dont-prompt tla-cache-tla-get-changeset
...
;;;;;;  tla-toggle-use-skip-present-option tla-toggle-use-forward-option
;;;;;;  tla-use-skip-present-option tla-use-forward-option tla-three-way-merge
;;;;;;  tla-commit-fix-missing-space tla-commit-headers-allowed-to-be-empty
...
(defvar tla-global-keymap (let ((map (make-sparse-keymap))) (define-key map tla--keyvec-log-entry (quote tla-add-log-entry)) (define-key map [65] (quote tla-archives)) (define-key map tla--keyvec-show-bookmark (quote tla-bookmarks)) (define-key map tla--keyvec-file-diff (quote tla-file-diff)) (define-key map tla--keyvec-ediff (quote tla-file-ediff)) (define-key map [111] (quote tla-file-view-original)) (define-key map tla--keyvec-diff (quote tla-changes)) (define-key map tla--keyvec-commit (quote tla-edit-log)) (define-key map [116] (quote tla-tag-insert)) (define-key map tla--keyvec-inventory (quote tla-inventory)) (define-key map [114] (quote tla-tree-revisions)) (define-key map tla--keyvec-logs (quote tla-logs)) (define-key map tla--keyvec-tree-lint (quote tla-tree-lint)) (define-key map tla--keyvec-update (quote tla-update)) (define-key map tla--keyvec-help (quote tla-help)) map) "\
...
(defvar tla-use-forward-option nil "\
...
(autoload (quote tla-toggle-use-forward-option) "xtla-defs" "\
Toggle the value of `tla-use-forward-option'." t nil)
...
;;;***

;;;### (autoloads (tla-browse) "xtla-browse" "xtla-browse.el" (16906
;;;;;;  35758))
